...
```{r echo=FALSE}
arrests %>% ggplot(aes(Rape, UrbanPop, label=region)) +geom_point(color = case_when(arrests$Rape>40 & arrests$UrbanPop < 50~ "#1b9e77", TRUE ~ "#7570b3")) 
```
...
```{r echo=FALSE}
arrests %>% ggplot(aes(Murder, Assault, label=region)) + geom_point() + geom_text()

```


```{r echo=FALSE}
arrests %>% ggplot(aes(Rape, UrbanPop, label=region)) + geom_point(color = case_when(arrests$Rape>40 & arrests$UrbanPop < 50~ "#1b9e77", TRUE ~ "#7570b3")) + geom_text(vjust=1.5, color = case_when(arrests$Rape>40 & arrests$UrbanPop < 50~ "#1b9e77", TRUE ~ "#7570b3"))
